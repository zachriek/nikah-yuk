const HeroSection = () => {
  return (
    <section className="h-screen bg-hero bg-contain bg-center bg-no-repeat bg-fixed relative" id="beranda">
      <div className="overlay"></div>
      <div className="container relative mx-auto h-full flex flex-col justify-center items-center">
        <h1 className="sm:text-6xl md:text-8xl text-5xl font-secondary text-zinc-50 leading-tight mb-4" data-aos="fade-down">
          Ali & Zahra
        </h1>
